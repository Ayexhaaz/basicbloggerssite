              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                    ...
                    <canvas id="transaction-history" class="transaction-chart chartjs-render-monitor" width="381" height="190" style="display: block; height: 127px; width: 254px;"></canvas>
              ...
              <div class="col-md-6 col-xl-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-527px, 0px, 0px); transition: 0.25s; width: 1847px;"><div class="owl-item cloned" style="width: 253.771px; margin-right: 10px;"><div class="item">
                        <img src="assets/images/dashboard/Img_5.jpg" alt="">
                      </div></div><div class="owl-item cloned" style="width: 253.771px; margin-right: 10px;"><div class="item">
                        <img src="assets/images/dashboard/img_6.jpg" alt="">
                      </div></div><div class="owl-item active" style="width: 253.771px; margin-right: 10px;"><div class="item">
                        <img src="assets/images/dashboard/Rectangle.jpg" alt="">
                      </div></div><div class="owl-item" style="width: 253.771px; margin-right: 10px;"><div class="item">
                        <img src="assets/images/dashboard/Img_5.jpg" alt="">
                      </div></div><div class="owl-item" style="width: 253.771px; margin-right: 10px;"><div class="item">
                        <img src="assets/images/dashboard/img_6.jpg" alt="">
                      </div></div><div class="owl-item cloned" style="width: 253.771px; margin-right: 10px;"><div class="item">
