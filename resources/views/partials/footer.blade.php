                                        ...
                                        <div class="footer-contacts">
                                            <div class="mb-3 mb-md-30">
                                                <a class="navbar-brand" href="/" aria-label="nav-brands">
                                                    <img src="{{asset('assets/images/placeholder.svg')}}" data-src="{{asset('assets/images/logo-white.png')}}" class="logo-light img-fluid" alt="footer-logo">                                    
                                                </a>
                                            </div>                                    
                            ...
                            <div class="footer-bottom-contents-area">
                                ...
                                <!-- social-icons -->
                                    ...
                                    <div class="d-flex gap-10">
                                        ...
                                        <a class="footer-logo" href="/index" aria-label="nav-brands">
                                            <img src="{{asset('assets/images/placeholder.svg')}}" data-src="{{asset('assets/images/logo-white.png')}}" class="logo-light img-fluid" alt="footer-logo-two">
                                        </a>
                                    </div>
    
                                    <p class="mb-0 lead">&copy; <span class="dynamic-year"> </span>. Exploreist. All rights reserved</p>
